  ...
  <div class="">
    <?php foreach ($places as $category) { ?>
      <div class="sectionCartagena__slick">
        ...
        <div class="space space--20 mobile"></div>
              ...
              <?php foreach ($category['places'] as $place) { ?>
                <div class="sectionCartagena__card">
                    <div class="sectionCartagena__padding">
                        ...
                        <h2 class="heading--28 color--4E6585">
                            <?php echo $place['name']; ?>
                        </h2>
                        ...
                        <?php if ($place['phone']) : ?>
                        <p class="heading--28 color--4f4f4f spacing--1" style="-webkit-text-stroke-width: 0.5px;letter-spacing: 1.4px;"><?php echo $place['phone']; ?></p>
                        <?php endif?>
    
                        <div class="space space--20"></div>
    
                        <?php if ($place['link']) : ?>
                            <a class="button button--primary" href="<?php echo $place['link']; ?>" target="_blank">
                            VER
                            </a>
                        <?php endif?>
                        </div>
